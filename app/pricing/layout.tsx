...
export const metadata: Metadata = {
  title: "Pricing",
  description:
    "BuildKit pricing: Free tier with 10K tokens/month. Upgrade to Pro or Team for more tokens and advanced features. Start building with AI today.",
  openGraph: {
    title: "Pricing | BuildKit",
