    ...
    export function AnimatedAIInput({
        ...
        const handleSubmit = async () => {
            ...
            if (mode === "chat" && onSubmit) {
                ...
                setValue("");
                adjustHeight(true);
                await onSubmit(submittedValue, selectedModel);
                return;
            }
                ...
                >
                    ...
                    <defs>
                        ...
                        >
                            ...
                            <stop offset="52.021%" stopColor="#a1a1aa" />
        ...
        return (
            <div className="w-full max-w-2xl py-4">
                <div className="bg-zinc-800/50 rounded-2xl p-1.5 border border-zinc-700/50">
                        ...
                        <div className="relative flex flex-col">
                            ...
                            >
                                <Textarea
                                    ...
                                    className={cn(
                                        "w-full rounded-xl rounded-b-none px-4 py-3 bg-zinc-900/80 border-none text-zinc-100 placeholder:text-zinc-500 resize-none focus-visible:ring-0 focus-visible:ring-offset-0",
                                        "min-h-[72px]"
                                    )}
                                    ref={textareaRef}
                            ...
                            <div className="h-14 bg-zinc-900/80 rounded-b-xl flex items-center">
                                <div className="absolute left-3 right-3 bottom-3 flex items-center justify-between w-[calc(100%-24px)]">
                                    <div className="flex items-center gap-2">
                                        <DropdownMenu>
                                            <DropdownMenuTrigger asChild>
                                                <Button
                                                    variant="ghost"
                                                    className="flex items-center gap-1 h-8 pl-1 pr-2 text-xs rounded-md text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800 focus-visible:ring-1 focus-visible:ring-offset-0 focus-visible:ring-zinc-500"
                                        ...
                                        <label
                                            className={cn(
                                                ...
                                                "hover:bg-zinc-700 focus-visible:ring-1 focus-visible:ring-offset-0 focus-visible:ring-zinc-500",
                                    ...
                                    <button
                                        type="button"
                                        className={cn(
                                            "rounded-lg p-2 bg-zinc-100 text-zinc-900",
                                            "hover:bg-zinc-200 focus-visible:ring-1 focus-visible:ring-offset-0 focus-visible:ring-zinc-500",
