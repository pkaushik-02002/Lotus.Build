                ...
                <div className="px-2 py-3">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-zinc-700 capitalize">{userData.planName} Plan</span>
                    </div>
                    <Link
                      href="/pricing"
          ...
          <div className="flex md:hidden">
            <Sheet>
              <SheetTrigger asChild>
                <button
                  type="button"
                  className="inline-flex items-center justify-center rounded-full p-1.5 text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-700"
              ...
              <SheetContent
                side="top"
                className="bg-[#f5f5f2] text-zinc-50 px-6 pt-16 pb-10 h-screen"
              >
                <div className="space-y-4">
                  {navLinks.map((link) => (
                    <Link
                      key={link.href}
                      href={link.href}
                      className="block text-3xl leading-tight font-medium tracking-wide text-zinc-50 hover:text-zinc-800 transition-colors"
                    >
                      {link.label}
                    </Link>
                  ))}
